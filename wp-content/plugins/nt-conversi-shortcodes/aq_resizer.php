...
if(!class_exists('Nt_Conversi_Aq_Resize')) {
    class Aq_Exception extends Exception {}

    class Nt_Conversi_Aq_Resize {
        ...
        public function process( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
            try {
                ...
                // Okay, leave the ship. This is a valid use case.
                ...
                error_log('Nt_Conversi_Aq_Resize.process() error: ' . $ex->getMessage());
...
if(!function_exists('nt_conversi_aq_resize')) {
    function nt_conversi_aq_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
        /* WPML Fix */
        ...
        $nt_conversi_aq_resize = Nt_Conversi_Aq_Resize::getInstance();
        return $nt_conversi_aq_resize->process( $url, $width, $height, $crop, $single, $upscale );
    }
}
